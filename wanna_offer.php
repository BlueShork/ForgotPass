...
if(isset($_SESSION['id']) AND isset($_SESSION['pseudo'])){
		...
		<html>
			<head>
				<title><?php site(); ?> - WOfferwall</title>
				<meta charset="utf-8">
...
?>
	...
	<?php
        ...
        <iframe src="https://wall.wannads.com/wall?apiKey=607ebbd8b3728369256886&userId=<?php echo $id; ?>" style="position:absolute; width: 100%;height:100%;top:55px; left:0px; bottom:0px; right:0px;  border:none; margin:0; padding:0; overflow:hidden; z-index:999999;frameborder='0';"></iframe>
