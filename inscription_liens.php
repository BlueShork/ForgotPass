...
if(isset($_SESSION['id']) AND isset($_SESSION['pseudo'])){
		...
		<html>
			<head>
				<title><?php site();?> - OfferToro</title>
				<meta charset="utf-8">
			...
			<?php 
				...
				<?php include('./class/get_mobile_menu.php'); ?>
					<ul class="menu none1">
						...
						<li class="fonts money" style="margin-top: 2px !important"><a href="#" class="coin"><div class="coins">
...
?>
	...
	<?php
		  ...
		  <iframe src="https://www.offertoro.com/ifr/show/28033/<?php echo $id;?>/12251" frameborder="0" width="860" height="2400" style="position:absolute; width: 100%;height:100%;top:55px; left:0px; bottom:0px; right:0px;  border:none; margin:0; padding:0; overflow:hidden; z-index:999999;frameborder='0';"></iframe> 
