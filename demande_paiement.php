...
xhr_object.send(null);
			...
			<!-- <?php 
				...
				<div class="contact">
					...
					$seuil = 1000;
					?>
					<p class="nop"><i class="fas fa-question-circle"></i>  E-Gardiens vous n'avez pas finis encore de compléter toutes les quêtes, il vous manque encore : <?php echo $seuil-$gains;?> G-Bucks</p>
					<?php
				}
				?> -->
				<div class="container">
				...
				<div id="global_giftcard" class="row">
					<div class="gift_card col">
						...
						<img src="https://www.ba-click.com/img/partenaires/paypal.png">
							...
							<div class="alert alert-danger" style="text-align: center"><i class="fas fa-exclamation-triangle"></i> L'email sera utilisée pour le versement</div>
							<?php 
