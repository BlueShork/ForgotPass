	...
	<html>
		...
		<nav>
			...
			<div class="tirerausort">
				<form method="post" action="tierausortjournalier_rand.php?id=<?php echo $_GET['id']; ?>">
			...
			<div class="more-givesaway">
				<p>Participation pour ce givesaway : </p>
				<?php 
			
				$reponse = $bdd->prepare('SELECT * FROM participations_journalier WHERE id_participation = :id');
				...
				while($donnees = $reponse->fetch()){
					?>
					<p class="ide"><?php echo ++$test; ?></p>
					<p class="tableau"><?php echo $donnees['id']; ?> . <?php echo $donnees['email'];?></p>
					<?php
				}
