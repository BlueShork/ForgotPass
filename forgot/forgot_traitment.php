...
<body style="margin:0px; padding:0px; -webkit-text-size-adjust:none;">
                                                            ...
                                                            <tr>
                                                                <td class="w580"  width="580">
                                                                    <h2 style="color:#7DCEA0; font-size:22px; padding-top:12px;">
                                                                        Récupération de votre mot de passe  </h2>

                                                                    <div align="left" class="article-content">
                                                                        <p> Veuillez suivre le lien ci-dessous pour réinitialiser votre mot de passe.</p>
  ...
  <div class="content">
    ...
    <p>Nous avons envoyé un lien à votre adresse email.</p>
  </div>
</div>
